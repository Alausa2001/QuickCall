...
def post_emergency_tips(token):
    ...
    emergency_tips = [
        ...
        },
        {
            ...
            "title": """
            1. Don’t Panic
            1. Witnessing an accident or another medical emergency can be scary and overwhelming, but you have to  stay calm to help the victim . So, take a deep breath, calm your nerves before proceeding to tip 2.
            ...
            4. Give First Aid if You Can
            While waiting for the ambulance, try to give first aid to the victim if you have knowlegde of first aid. If you do not know how to administer first aid treatments, then leave the victim and ensure proper ventilation. There should not be a crowd surrounding the victim as that can be fatal.
            """,
